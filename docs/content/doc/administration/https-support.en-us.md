...
To learn more about the config values, please checkout the [Config Cheat Sheet]({{< relref "doc/administration/config-cheat-sheet#server-server" >}}).
...
Setup up your reverse proxy as shown in the [reverse proxy guide]({{< relref "doc/administration/reverse-proxies.en-us.md" >}}).
